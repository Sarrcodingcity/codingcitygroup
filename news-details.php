...
if($query):
  echo "<script>alert('commentaire soumis avec succès. Le commentaire sera affiché après examen par l'administrateur ');</script>";
...
<p>
          ...
          <b>Publier par </b> <?php echo htmlentities($row['postedBy']);?> sur</b><?php echo htmlentities($row['postingdate']);?> |
...
<!---Comment Section --->
 ...
 <div class="row" style="margin-top: -8%">
   <div class="col-md-8">
<div class="card my-4"  style="background-color: #0B2884;">
            <h5 class="card-header text-white fw-bold">Laissez un commentaire:</h5>
            <div class="card-body">
