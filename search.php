...
?>
      ...
      <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
              ...
              <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="btn btn-danger">Voir plus &rarr;</a>
            </div>
            <div class="card-footer text-muted">
              Poster sur <?php echo htmlentities($row['postingdate']);?>
...
<?php } ?>
    ...
    <ul class="pagination justify-content-center mb-4">
        <li class="page-item"><a href="?pageno=1"  class="page-link">D'abord</a></li>
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>" class="page-link">Précédent</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?> " class="page-link">Suivent</a>
        </li>
